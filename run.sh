...
######################################
python3 train.py --data_dir $AADB --label_dir $LABEL_AADB --lr $LR --name $date"AADB_MobileNet_2" --batch_size 32 --testdata_dir $AADB --testlabel_dir $AADB_test_label --crop_num 2
